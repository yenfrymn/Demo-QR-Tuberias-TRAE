      ...
      <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white shadow rounded-lg">
          <div class="px-4 py-5 sm:p-6">
            <h1 class="text-2xl font-semibold text-gray-900 mb-6">Edit Company</h1>
            
            <form v-if="company" @submit.prevent="submitForm" class="space-y-6">
              <div>
...
const fetchCompany = async () => {
  try {
    const response = await fetch(`${import.meta.env.VITE_API_URL}/api/companies/${route.params.id}`, {
      headers: {
    ...
    if (response.ok) {
      ...
      form.value = {
        ...
        is_active: company.value.is_active
      }
